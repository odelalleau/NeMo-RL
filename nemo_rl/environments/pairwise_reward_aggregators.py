...
class PairwiseRewardAggregator(ABC):
    ...
    def aggregate_scores(
        ...
        comparison_metadata: List[Tuple[str, int, int, int]],  # (prompt_key, resp_i, resp_j, judge_idx)
...
class IndividualScoreAggregator(PairwiseRewardAggregator):
    ...
    def aggregate_scores(
        ...
        for (request_id, score_1, score_2, ranking_score), (prompt_key, resp_i, resp_j, judge_idx) in zip(
